...
class AppConstants {
  ...
  static const String brandUri = '/api/v1/brands?guest_id=';
  ...
  static const String latestProductUri = '/api/v1/products/latest?guest_id=';
  static const String newArrivalProductUri = '/api/v1/products/latest?guest_id=';
  static const String topProductUri = '/api/v1/products/top-rated?guest_id=';
  static const String bestSellingProductUri = '/api/v1/products/best-sellings?guest_id=';
  static const String discountedProductUri = '/api/v1/products/discounted-product?guest_id=';
  static const String featuredProductUri = '/api/v1/products/featured?guest_id=';
  static const String homeCategoryProductUri = '/api/v1/products/home-categories?guest_id=';
  ...
  static const String getSuggestionProductName = '/api/v1/products/suggestion-product?guest_id=';
  ...
  static const String dealOfTheDay = '/api/v1/dealsoftheday/deal-of-the-day?guest_id=';
  ...
  static const String mostDemandedProduct = '/api/v1/products/most-demanded-product?guest_id=';
  ...
  static const String justForYou = '/api/v1/products/just-for-you?guest_id=';
  static const String mostSearching = '/api/v1/products/most-searching?guest_id=';
